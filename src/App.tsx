...
import { Dumbbell, Users, Monitor, Sparkles, ChevronRight, Twitter, Facebook, Menu, X, ArrowRight, Star, Calendar, MessageCircle, Search, User, ChevronDown } from 'lucide-react';
...
function ModernDesign() {
  ...
  if (showOriginal) {
    return <OriginalDesign onToggleDesign={toggleDesign} />;
  }
    ...
    <div className="bg-gradient-to-b from-[#0a0a0a] to-[#121212] text-white min-h-screen font-sans">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center pt-16">
        ...
        <div className="absolute bottom-10 left-0 right-0 flex justify-center z-20 animate-bounce">
          <a href="#about" className="text-white hover:text-white transition-colors duration-300">
            <ChevronDown size={32} />
          </a>
        </div>
      </section>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-xl overflow-hidden border border-white/10 hover:border-blue-500/50 transition-all duration-300 group h-full flex flex-col">
                  <div className="relative">
                    <img 
                      ...
                      alt="スカウトへメッセージ" 
                      className="w-full h-48 sm:h-64 object-cover object-left group-hover:scale-105 transition-transform duration-500"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent"></div>
                  </div>
                  <div className="p-4 sm:p-8 flex-grow flex flex-col">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-12">
            <div>
              ...
              <ul className="mt-2 space-y-0.5">
                <li>
                  <a href="#home" className="text-white hover:text-blue-400 transition-colors duration-300 flex items-center py-1">
                    <ChevronRight size={14} className="mr-1" /> ホーム
                  </a>
                </li>
                <li>
                  <a href="#services" className="text-white hover:text-blue-400 transition-colors duration-300 flex items-center py-1">
                    <ChevronRight size={14} className="mr-1" /> サービス内容
                  </a>
                </li>
                <li>
                  <a href="#testimonials" className="text-white hover:text-blue-400 transition-colors duration-300 flex items-center py-1">
                    <ChevronRight size={14} className="mr-1" /> スカウトの声
                  </a>
                </li>
                <li>
                  <a href="#operators" className="text-white hover:text-blue-400 transition-colors duration-300 flex items-center py-1">
...
function OriginalDesign({ onToggleDesign }) {
  return (
    <div>
      {/* Original design content would go here */}
      <button onClick ={ onToggleDesign}>Switch to Modern Design</button>
    </div>
  );
}
